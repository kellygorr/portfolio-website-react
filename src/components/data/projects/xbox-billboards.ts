...
export const xboxBillboards: IProject = {
    ...
    content:[
        ...
        {
            "header":"Details",
            "body":"Platform: Xbox One with Kinect (voice and gesture)<br/>Template: jQuery/Javascript, JSON, HTML, CSS<br/>Billboard generator tool: PHP, Ajax, jQuery/Javascript, JSON, HTML, CSS<br/>Designed by: Xbox Programing Team designers<br/>Interaction Design: Kelly Gorr & Jana Sheehan"
        },
        {
