...
export const interactiveVideoPlaylist: IProject = {
    ...
    content:[
        ...
        {
            "header":"Details",
            "body":"Platform: Xbox One with Kinect (voice and gesture)<br/>Countries: United States, Canada<br/>Dates: Aug. 2014<br/>Designers: Bruce Warren, Jacqueline Montplaisir"
        },
        {
        ...
        {
            "header":"Details",
            "body":"Platform: Xbox One with Kinect (voice and gesture)<br/>Placement: Featured on the Xbox One dashboard home page and games section<br/>Countries: United States, Canada<br/>Dates: Sept. 2014<br/>Designer: James Aparis"
        },
        {
            "header":"Xbox One Video Capture",
            "label":"Slipknot",
