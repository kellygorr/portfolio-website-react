...
export const GlobalStyles = createGlobalStyle`
	...
	*:focus {
	...
	@font-face {
		...
		src: url('http://www.kellygorr.com/assets/fonts/museoslab/museoslab.woff2') format('woff2'), url('http://www.kellygorr.com/assets/fonts/museoslab/museoslab.woff') format('woff');
		font-weight: normal;
		font-style: normal;
	}
